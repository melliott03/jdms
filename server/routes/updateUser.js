...
const accountSid = configsty.TWILIO_ACCOUNT_SID;
const authToken = configsty.TWILIO_AUTH_TOKEN;
const workspaceSid = configsty.TWILIO_WORKSPACE_SID;
  ...
  router.get("/taskRouterWorkerToken", function(req, res, next){
    console.log('inside route /taskRouterWorkerToken, req.body::::',req.body);
    console.log('inside route /taskRouterWorkerToken, req.user::::',req.user);
    const workerSid = req.user.twilioSids.workerSid;
