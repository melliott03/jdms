...
myApp.controller('XAccountCtrl4', ["$scope", "$location", '$anchorScroll','$filter', '$http', '$timeout', '$document', '$mdDialog', "WorkService", 'stripe', 'Upload', function($scope, $location, $anchorScroll, $filter, $http, $timeout, $document, $mdDialog, WorkService, stripe, Upload) {
  ...
  $scope.rechargeTo = workService.userObject.response.autoPaymentsChoice.autoRecharge.rechargeTo;
  $scope.fallsBelow = workService.userObject.response.autoPaymentsChoice.autoRecharge.fallsBelow;
  $scope.autoRecharge.autoRecharge = workService.userObject.response.autoPaymentsChoice.autoRecharge.autoRecharge;
