...
myApp.controller('XAccountCtrl4', ["$scope", "$location", '$anchorScroll','$filter', '$http', '$timeout', '$document', '$mdDialog', "WorkService", 'stripe', 'Upload', function($scope, $location, $anchorScroll, $filter, $http, $timeout, $document, $mdDialog, WorkService, stripe, Upload) {
  ...
  $scope.rechargeTo = workService.userObject.autoPaymentsChoice.autoRecharge.rechargeTo;
  $scope.fallsBelow = workService.userObject.autoPaymentsChoice.autoRecharge.fallsBelow;
  $scope.autoRecharge.autoRecharge = workService.userObject.autoPaymentsChoice.autoRecharge.autoRecharge;
