...
myApp.directive('stDateRange', ['$timeout','WorkService', function ($timeout, WorkService) {
  // var workService = WorkService;
  // console.log('arrayOfObjDates[0].toDate()::', workService.customerGraphDataObject);
  // var after = ''+workService.customerGraphDataObject.data.arrayOfObjDates[0].toDate();
  return {
    restrict: 'E',
    require: '^stTable',
    scope: {
